...
//
//    private List<Group> mFolders = new ArrayList<>();
//
...
//                    FolderGroup.getDummy().insertInto(mFolders, media);
//                }
...
//                mFolders = FolderGroup.getDummy().group(itemList);
//                FolderGroup.sort(mFolders);
//                VLCApplication.runOnMainThread(new Runnable() {
//                    @Override
//                    public void run() {
...
//                    ((FolderGroup) item).getFolderPath(), false);
//        }
//    }
//
//    @Override
...
//    }
//
//    public String getTitle(String folderPath) {
