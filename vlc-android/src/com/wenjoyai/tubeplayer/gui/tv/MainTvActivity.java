...
import com.wenjoyai.tubeplayer.RecommendationsService;
...
import com.wenjoyai.tubeplayer.gui.tv.browser.MusicFragment;
import com.wenjoyai.tubeplayer.gui.tv.browser.VerticalGridActivity;
...
public class MainTvActivity extends BaseTvActivity implements OnItemViewSelectedListener,
    ...
    public void onItemClicked(Presenter.ViewHolder itemViewHolder, Object item, RowPresenter.ViewHolder rowViewHolder, Row row) {
        if (row.getId() == HEADER_CATEGORIES) {
            ...
            if (id == ID_SETTINGS)
                startActivityForResult(new Intent(this, com.wenjoyai.tubeplayer.gui.tv.preferences.PreferencesActivity.class), ACTIVITY_RESULT_PREFERENCES);
            else if (id == ID_ABOUT)
                startActivity(new Intent(this, com.wenjoyai.tubeplayer.gui.tv.AboutActivity.class));
            else if (id == ID_LICENCE)
                startActivity(new Intent(this, com.wenjoyai.tubeplayer.gui.tv.LicenceActivity.class));
        } else {
