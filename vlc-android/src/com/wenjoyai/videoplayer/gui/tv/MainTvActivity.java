...
import com.wenjoyai.videoplayer.RecommendationsService;
import com.wenjoyai.videoplayer.StartActivity;
import com.wenjoyai.videoplayer.VLCApplication;
import com.wenjoyai.videoplayer.gui.helpers.AudioUtil;
...
import com.wenjoyai.videoplayer.gui.tv.browser.BaseTvActivity;
import com.wenjoyai.videoplayer.gui.tv.browser.MusicFragment;
import com.wenjoyai.videoplayer.gui.tv.browser.VerticalGridActivity;
...
public class MainTvActivity extends BaseTvActivity implements OnItemViewSelectedListener,
    ...
    public void onItemClicked(Presenter.ViewHolder itemViewHolder, Object item, RowPresenter.ViewHolder rowViewHolder, Row row) {
        if (row.getId() == HEADER_CATEGORIES) {
            ...
            if (id == ID_SETTINGS)
                startActivityForResult(new Intent(this, com.wenjoyai.videoplayer.gui.tv.preferences.PreferencesActivity.class), ACTIVITY_RESULT_PREFERENCES);
            else if (id == ID_ABOUT)
                startActivity(new Intent(this, com.wenjoyai.videoplayer.gui.tv.AboutActivity.class));
            else if (id == ID_LICENCE)
                startActivity(new Intent(this, com.wenjoyai.videoplayer.gui.tv.LicenceActivity.class));
        } else {
