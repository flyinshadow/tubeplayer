...
import com.wenjoyai.videoplayer.gui.SearchActivity;
...
public class StartActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (Intent.ACTION_SEARCH.equals(action) || "com.google.android.gms.actions.SEARCH_ACTION".equals(action)) {
            startActivity(intent.setClass(this, tv ? com.wenjoyai.videoplayer.gui.tv.SearchActivity.class : SearchActivity.class));
            finish();
            return;
