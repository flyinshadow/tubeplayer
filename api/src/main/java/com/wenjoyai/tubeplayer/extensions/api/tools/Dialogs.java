 ...
 * ***************************************************************************
 */
package com.wenjoyai.tubeplayer.extensions.api.tools;
...
import com.wenjoyai.tubeplayer.plugin.api.R;
    ...
    public static AlertDialog showInstallVlc(@NonNull final Activity activity) {
        return showAlertDialog(activity, R.string.vlc_error_title, R.string.vlc_error_message,
                new DialogInterface.OnCancelListener() {
                    ...
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                        activity.startActivity(new Intent(Intent.ACTION_VIEW, Uri.parse("http://play.google.com/store/apps/details?id=com.wenjoyai.tubeplayer")));
                        dialog.dismiss();
                        activity.finish();
                    }
                }, null);
